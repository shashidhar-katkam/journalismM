const Files = require('./schema/imageCard');
...
module.exports = {
    ...
    getAllFiles: function (query, callback) {
        ...
        console.log(skipno);
        try {
            Files.find({show: true}, { fileNewName: 1, filePath: 1, fileType: 1 }, callback).sort({ dateTime: -1 }).skip(skipno).limit(40);
        } catch (e) {
            console.log(e);
            callback(e, null);
        }
    ...
    getAllFilesForAdmin: function (query, callback) {
        ...
        console.log(skipno);
        try {
            Files.find({}, { fileNewName: 1, filePath: 1, fileType: 1, show: 1 }, callback).sort({ dateTime: -1 }).skip(skipno).limit(40);
        } catch (e) {
            console.log(e);
            callback(e, null);
        }
